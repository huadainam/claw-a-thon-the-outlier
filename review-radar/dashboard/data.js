...
(function () {
  ...
  var I18N = {
    en: {
      ...
      kpi_health_formula_title:"Review health formula", kpi_health_p:"positive reviews", kpi_health_c:"complaints", kpi_health_b:"bug reports", kpi_health_n:"classified reviews",
      ...
      compare_cta:"Compare", compare_loading:"Comparing apps...", compare_loading_status:"Loading review, sentiment, and rating data", compare_min:"Select at least 2 apps", selected_count:"selected", compare_clear_selection:"Clear selection", compare_again:"Change selection", export_compare:"Export comparison",
    ...
    vi: {
      ...
      kpi_health_formula_title:"Công thức điểm sức khỏe", kpi_health_p:"review tích cực", kpi_health_c:"phàn nàn", kpi_health_b:"bug", kpi_health_n:"review đã phân loại",
      ...
      compare_cta:"So sánh", compare_loading:"Đang so sánh...", compare_loading_status:"Đang tải dữ liệu đánh giá, cảm xúc và phân bố sao", compare_min:"Chọn ít nhất 2 ứng dụng", selected_count:"đã chọn", compare_clear_selection:"Xóa lựa chọn", compare_again:"Đổi lựa chọn", export_compare:"Xuất bảng so sánh",
